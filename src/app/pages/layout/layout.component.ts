...
@Component({
  selector: 'app-layout',
  standalone: true,
  imports: [RouterOutlet, NavbarComponent, SidebarComponent, TicketComponent, ProfilesComponent, NgIf, CustomSidebarComponent, CommentsDetailsComponent, ProjectsDetailsComponent],
